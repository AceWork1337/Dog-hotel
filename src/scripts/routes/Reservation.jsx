                ...
                <Row>
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <Row>
                            ...
                            <Input s={12} m={4} name="from" label="Pick date from" type="date" icon="date_range" className="datepicker"  value={today} onChange="this.handleChange.bind(this); this.ace"/>
