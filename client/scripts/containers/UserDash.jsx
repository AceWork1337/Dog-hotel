...
export default class UserDash extends React.Component {
     ...
     handleSubmit = event => {
        ...
        console.log(user)
        axios.post(`http://34.243.34.187/backend/modify`, user,{headers:{'Content-Type':'application/json'}})
          .then(res => {
            console.log(res);
        ...
        return(
            <div className="userDashDiv">
                ...
                <Row>
                    ...
                    <Input s={6} type="text" label="Change Last Name" name="lastName" onChange={this.handleChange.bind(this)}><Icon>account_circle</Icon></Input>
